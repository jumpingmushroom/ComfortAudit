...
| | |
|---|---|
| Host | `equ@192.168.1.160` — `gamingrig01`, CachyOS, kernel 7.2.4 |
...
```
equ@192.168.1.160:~/.config/r2modmanPlus-local/Valheim/profiles/Mods/BepInEx/plugins/ComfortAudit/
```
...
- *Reachable host* — `equ@192.168.1.160` is up and analysed; §5.5 is concrete.
